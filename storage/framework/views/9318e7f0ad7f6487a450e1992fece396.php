        ...
        <div class="main-content">
            ...
            <div class="header">
                <div class="header-title">
                    <h1>Dashboard</h1>
                    <p>Xin chào, <?php echo e(Session::get('hoTen')); ?>!</p>
                </div>
                <div class="header-user">
                    <div class="user-info">
                        <p><strong><?php echo e(Session::get('hoTen')); ?></strong></p>
                        <p>Admin</p>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-value"><?php echo e($studentCount); ?></div>
                    </div>

                    <div class="card">
                        <div class="card-icon">👨‍🏫</div>
                        <div class="card-title">Giáo Viên</div>
                        <div class="card-value"><?php echo e($teacherCount); ?></div>
                    </div>

                    <div class="card">
                        <div class="card-icon">⏳</div>
                        <div class="card-title">Giáo Viên Chờ Duyệt</div>
                        <div class="card-value card-value-highlight"><?php echo e($pendingTeachers); ?></div>
                    </div>

                    <div class="card">
                        <div class="card-icon">🚫</div>
                        <div class="card-title">Người Dùng Bị Chặn</div>
                        <div class="card-value"><?php echo e($blockedUsers); ?></div>
                    </div>
                </div>
                ...
                <div class="quick-actions">
                    <a href="<?php echo e(route('admin.teachers.pending')); ?>" class="action-btn">
                        👁️ Xem Giáo Viên Chờ Duyệt (<?php echo e($pendingTeachers); ?>)
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="action-btn success">
                        📋 Quản Lý Người Dùng
                    </a>
                </div>
            </div>
...
<?php /**PATH D:\xampp\htdocs\thuctap\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>