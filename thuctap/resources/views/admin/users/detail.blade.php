                        ...
                        <div class="action-buttons">
                            @if($user->TrangThai === 'Active')
                                <form method="POST" action="{{ route('admin.users.block', $user->MaNguoiDung) }}" style="display: inline;">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-block" onclick="return confirm('Xác nhận chặn người dùng này, các dữ liệu của người dùng sẽ giữ nguyên')">🚫 Chặn Tài Khoản</button>
                                </form>
                            ...
                            <form method="POST" action="{{ route('admin.users.delete', $user->MaNguoiDung) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-delete" onclick="return confirm('Xác nhận xóa tài khoản, các dữ liệu liên quan như đề thi hay bài làm sẽ bị xóa theo')">❌ Xóa Tài Khoản</button>
                            </form>
                        </div>
                    @endif
                </div>
